    ...
    <div id="home">
        <div id="login-form">
            ...
            <div id="login-body">
                ...
                width: 462px;">
                <span class="label-input">Mật khẩu</span><span id="fogot-password" href
                ="google.com">Quên mật khẩu</span>
                </div>
                <input type="password">
                <div class="login-button">Đăng nhập</div>
                <p class="login-with">hoặc đăng nhập bằng</p></p>
                <div
                style="
                display: flex;
                ...
                <p class="footer">
                    Có tài khoản rồi?<a href="google.com">Đăng nhập ngay!</a>
                </p>
            </div>
        </div>
    </div>
